...
class DocumentView extends Component {
  ...
  _onClick() {
    console.log("DocumentView onClick......");
  ...
  renderFullView () {
    ...
    console.log("DocumentView renderFullView documentview: ", doc);
    console.log("DocumentView renderFullView state: ", this.state);
    ...
    if (this.state.bookViewMode == "Lite Mode"){
      ...
      pdf = (
        <PDF file={getFileBaseURL() + bucket + "/" + doc.id}
...
DocumentView.propTypes = {
  ...
  documentview: PropTypes.object,
  dispatch: PropTypes.func.isRequired
};

const mapStateToProps = (state, props) => {
  console.log("documentview mapStateToProps state: ", state);
  
  const category = 'documentview';
