...
class AssetInfo extends Component {
  ...
  renderFullView () {
    ...
    var asset = this.props.assetitem1.get('result').get('item');
    console.log("assetinfo renderFullView asset: ", asset);
...
const mapStateToProps = (state, props) => {
  const category = 'assetinfo';

  return {
    category: category,
    assetitem1: state.index.getIn(['categories', category])
